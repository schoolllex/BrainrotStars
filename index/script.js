        ...
        if (this.ui.mainBtn) {
            this.ui.mainBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    const response = await fetch('https://darkgoldenrod-frog-258465.hostingersite.com/game/find-match', {
                        method: 'POST',
                        headers: {
...
const joinMatch = async (matchCode) => {
  ...
  try {
    ...
    const response = await fetch('https://darkgoldenrod-frog-258465.hostingersite.com/game/join', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
